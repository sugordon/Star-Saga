...
public class Odin extends Battleship {
	String name;
	...
	public Odin() {
		...
		reference.add(new Point(-1,2));
		reference.add(new Point(1,2));
		reference.add(new Point(0,-1));
		reference.add(new Point(-1,-1));
		reference.add(new Point(1,-1));
		reference.add(new Point(-2,-1));
		reference.add(new Point(2,-1));
		reference.add(new Point(-2,-2));
		reference.add(new Point(2,-2));
		...
		name = "Odin";
	    try {
			img = ImageIO.read(new File("./sprites/fullships/odin.png"));
		} catch (IOException e) {
